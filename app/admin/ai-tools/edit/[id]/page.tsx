...
export default function EditAIToolPage({ params }: EditAIToolPageProps) {
  ...
  useEffect(() => {
    // Load AI tool data
    const tool = aiToolData[params.id as keyof typeof aiToolData]
    if (tool) {
      setFormData({
        name: tool.name,
  ...
  const handleSave = () => {
    ...
    console.log("Updated AI Tool data:", aiToolData)
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold">AI Alətini Redaktə Et</h1>
          </div>
